        ...
        <div class="pull-right">
         ...
         <ul class="">
              <li class="dropdown user hidden-xs"><a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img width="34" height="34" src="images/avatar-male.jpg" /><                <?php echo $username ?>
<b class="caret"></b></a>
     ...
     <form action="<?php echo base_url("index.php/users") ?>">
      ...
      <a class="btn btn-default-outline btn-block" href="<?php echo base_url("index.php/users/register")?>">Sign up now</a>
    </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="list-group">
              <a class="list-group-item " href="<?php echo base_url("index.php/welcome")?>">
                <p>
              ...
              </a><a class="list-group-item active" href="<?php echo base_url("index.php/payments")?>">
                <p>
...
<?php echo $success ?>
     ...
     <div class="col-sm-12">
          ...
          <form <?php echo form_open('payments/pay'); ?> 
           class="col-sm-10">
        ...
        <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input class="form-control" type="text" placeholder="choose house id" name = "houseid" required ="true">
          </div>
        ...
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><i class="icon-user"> NAME</i></span>
            <input class="form-control" type="text" placeholder="fullname">
          </div>
        </div>
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><i class="icon-envelope"> ADDRESS</i></span><input class="form-control" type="text" placeholder="address">
          </div>
        </div>
        <div class="form-group">
          <div class="input-group">
        ...
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><i class="icon-dollar">  AMOUNT PAID</i></span><input class="form-control" type="text" placeholder="amount paid" required ="true" name ="amount">
          </div>
        </div>
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><i class="icon-lock"></i> PAYMENT METHOD</span><input class="form-control" type="text" placeholder="Select payment method" required ="true" name="method">
          </div>
        </div>
        <input class="btn btn-lg btn-primary btn-block" type="submit" value="BOOK HOUSE">
         </form>
    </div>
 </div>
