        ...
        <div class="pull-right">
         ...
         <ul class="">
              <li class="dropdown user hidden-xs"><a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img width="34" height="34" src="images/avatar-male.jpg" />Admin<b class="caret"></b></a>
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="list-group">
              <a class="list-group-item active" href="<?php echo base_url("index.php/welcome")?>">
                <p>
                  <span class="badge"><span class = "se7en-home"></span></span>HOME
                </p>
              </a><a class="list-group-item" href="<?php echo base_url("index.php/houses")?>">
                <p>
                  <span class="badge"><span class = "se7en-forms"></span></span>LISTING
                </p>
              </a><a class="list-group-item" href="<?php echo base_url("index.php/payments")?>">
                <p>
                  <span class="badge"><span class = "se7en-charts"></span></span>PAYMENTS
                </p>
              </a><a class="list-group-item" href="#">
                <p>
                  <span class="badge"><span class = "se7en-pages"></span></span>PROJECTS
                </p>
              </a><a class="list-group-item" href="<?php echo base_url("index.php/about")?>">
                <p>
                  <span class="badge"><span class = "se7en-feed"></span></span>ABOUT US
                </p>
              </a>
            </div>
          </div>
...
<div class = "row">
          <?php echo $success ?>
     <div class="col-sm-12">
            <form  <?php echo form_open('admin/addagent'); ?> 
     class="col-sm-6">
        ...
        <div class="form-group">
              ...
              <div class="input-group">
                  <span class="input-group-addon" ><i class="icon-user" style = "width :  100px"> AGENT ID</i></span>
                <input class="form-control" type="text" placeholder="agent number" name="agentid" required ="true">
          </div>
        ...
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><i class="icon-user"> SURNAME</i></span>
            <input class="form-control" type="text" placeholder="agent surname " name="surname" required ="true" >
          </div>
        </div>
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><i class="icon-envelope"> FIRST NAME</i></span><input class="form-control" type="text"
             placeholder="first name" required ="true" name = "firstname">
          </div>
        </div>
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><i class="icon-phone">  PHONE NUMBER</i></span><input class="form-control" type="text" placeholder="phone number"
        ...
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><i class="icon-user">  CLIENT</i></span><input class="form-control" type="text" placeholder="name of client assigned"
            name="client" required ="true">
          </div>
        </div>
        <input class="btn btn-lg btn-primary btn-block" type="submit" value="ADD AGENT">
         </form>
        

        <form  <?php echo form_open('admin/addhouse'); ?> 
      class="col-sm-6">
          <div class="form-group">
            
              <div class="input-group">
                  <span class="input-group-addon" ><i class="icon-user" style = "width :  100px"> HOUSE ID</i></span>
                <input class="form-control" type="text" placeholder=" house id" required ="true" name="houseid">
          </div>
        ...
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><i class="icon-user"> LOCATION</i></span>
            <input class="form-control" type="text" placeholder="location" name="location" required ="true">
          </div>
        </div>
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><i class="icon-dollar"> COST</i></span><input class="form-control" type="text" placeholder="cost" 
            name="cost" required ="true">
          </div>
        </div>
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><i class="icon-home"> ROOMS</i></span><input class="form-control" type="text" placeholder="number of rooms" 
        ...
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><i class="icon-dollar">  SIZE</i></span><input class="form-control" type="text" placeholder="size of room"
            name="size" required ="true">
          </div>
        </div>
        <input class="btn btn-lg btn-primary btn-block" type="submit" value="ADD HOUSE">
         </form>
    </div>
 </div>
     ...
     <div class="navbar navbar-bottom" style = "background : #000;">
        <div class="container-fluid bottom-bar" >
<ul>
         <li> <a href=""> Copyright se7en Real Estate</a> </li>
