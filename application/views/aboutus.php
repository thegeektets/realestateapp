       ...
       <div class="row">
          ...
          <div class="col-sm-3">
            <div class="list-group">
              ...
              </a><a class="list-group-item active" href="<?php echo base_url("index.php/about")?>">
                <p>
...
follow us
  ...
  <form class="">
        ...
        <div class="form-group">
            <legend>News Letter Subcription</legend>
              <div class="input-group">
                  <span class="input-group-addon" ><i class="icon-envelope" style = "width :  100px">EMAIL</i></span>
                <input class="form-control" type="text" placeholder="your email addres">
          </div>
        ...
        <input class="btn btn-lg btn-primary btn-block" type="submit" value="SUBSCRIBE">
            ...
            <div class="widget-container fluid-height">
              <div class="widget-content">
                        ...
                        <h2>Our Details</h2>
                        <p>Se7en is a real estate agency that enables clients to get access to houses for purchases and renting</p>
                        <h3>Email</h3> <a href="mailto:">se7en@gmail.com</a>

                        
                        <h3>Offices</h3>Mount Kenya University
